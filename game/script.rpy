...
label restaurant_test_exam:
    ...
    "I nervously handed the paper to Harumi who was currently studying on the other side of the table. I had taken so long to complete the example answer sheet she gave me that she eventually went on to do something else instead.. I feel so bad... "
    "Here's my paper madaam!" 
    "Oh... thanks for the hard work Akari-san. Please let me check your paper for a moment."
    "Of course!" 
    "Slowly, Harumi checked the contents of my paper line by line. As she continued, the motion of her pen gradually slowed down, as her perfect straight lines became jagged as she progressed down the paper. By the end of it, it seemed like she was struggling to check as her pen was starting to shake..."
    "Harumi-san, are you alright?"
    "Um... cough cough, of course. I apologize for the wait. Here is your paper. My I go to the restroom for a bit?" 
    "Sure!"
    "harumi made her way to the bathroom, and I was left alone with my paper at hand. I checked my score and was surprised by it's contents. "
    "5. I had scored a measly five points out of the thirty total. To put it frankly, it was a disaster, no, a tragedy. A tragedy so drastic that it was able to put Harumi into panic. Perhaps the reason she went to the bathroom was because she doesn't know how to handle someone like me... deciding on giving her some alone time, I waited patiently, simply checking the contents of my paper, seeing what i did wrong and what i should've done. "
    "Time passed quickly, and before i knew it, it has been 15 minutes since she went to the restroom. Worried, i finally stood up from my chair and approached the restroom stall. "
    "There i could here someone familiar talking. I slowly opened the door and was faced with a surprising situation. Something nobody would ever expect of the gentle, kind and saint-like harumi-"
    "What even was that! How can someone be so dull witted! It doesn't make sense! I thought humans are all supposed to have some kind of intelligence, but to think that she couldn't even answer the common sense questions?!" 
    "A shocking scene was presented to me on the other side of the door. Harumi, throwing out harsh words as if they were nothing. "
    "How does not know what's heavier, a kilogram of steel or a kilogram of feathers? It's right there in the question! They're the same! How can someone be so worthless!" 
    "{i}*Goufh!{/i}"
    "{i}Harsh!{/i}" 
    "This is an impossible task... I thought it would be beneficial for me since it was sensei asking, but... Maybe this is punishment for being too popular?" 
    "{i}what's with her ego!?{/i}"
    "No... i've never failed before... you can do this Harumi. Smile like you always do. No matter what happens, I--- ...eh?" 
    "It seems like she finally noticed that i was watching her whole rant, stopping dead on her tracks, the room became silent."
    "You... did you see?" 
    "Errr... yes?" 
    "Did you hear everything?" 
    "Affirmative." 
    "Then, do i need to tell more?"
    "Tell me what?" 
    "Do not speak of this event to anyone. The moment you do, I'll make sure you will regret it."
    "...I shall do what you ask" 
    "Good, sigh*. I apologise for what you've witnessed, Akarin-san. I believe it is the best interest of both parties that we finish up for the day here. We will meet again after class in this restaurant to continue your studying, understood?" 
    "Harumi continued as if the whole ordeal that happened just a few seconds ago did not happen."
    "You... you're still willing to teach me?" 
    "Of course, it was the request of sensei after all. And I never back down on the things i accepted."
    "Finally, she started towards the exit of the restaurant with me following closely. "
    "Of course we made sure to pick up our bags before leaving. But before Harumi left for good, she suddenly stops- "
    "Here's my LINE ID, it'd be easier to organize if we can talk online afterall, I'll keep my guard down on you since you already know anyway." 
    "Harumi then hands me a small piece of paper containing her contact information. "
    "Thank you..." 
    "Well, let me reintroduce myself, my name is Harumi, and although you've discovered the real me, make no mistake, I will make you pass your exam. Please don't be late for tomorrow."  
    "She continues- now with her seiso voice- "
    "Well then, thank you for the pleasant afternoon and for keeping me company. We shall start our proper lessons tomorrow. I look forward to meeting you again Akari-san, Farewell."
